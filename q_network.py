...
class QNetwork(nn.Module):
    ...
    Based on the architecture described in the DeepMind 2015 Nature paper.
    Takes stacked grayscale frames as input and outputs Q-values for each action.
    """
    ...
    def forward(self, x):
        ...
        This is called when we pass data into the model: output = model(input)
