    ...
    if mode == 'new':
        try:
            episode_rewards, episode_losses = train(
                ...
                all_rewards=episode_rewards, all_losses=episode_losses,
                print_every=print_every, moving_avg_window=moving_avg_window,
                target_reward=target_reward, checkpoint_every=checkpoint_every,
                model_filepath=model_filepath, history_filepath=history_filepath,
                plot_filepath=plot_filepath, is_new_run=True,
            )
        ...
        try:
            episode_rewards, episode_losses = train(
                ...
                target_reward=target_reward, checkpoint_every=checkpoint_every,
                model_filepath=model_filepath, history_filepath=history_filepath,
                plot_filepath=plot_filepath, is_new_run=not checkpoint_loaded,
            )
        except KeyboardInterrupt:
            print("\nTraining interrupted by user.")
        finally:
